...
public class TutoringPromptTemplatesTests
{
    ...
    [Fact]
    public void ParseProblemResponse_ValidResponse_ReturnsCorrectSections()
    {
        var response = """
            DESCRIPTION:
        ...
        var (description, starterCode) = _templates.ParseProblemResponse(response);
    ...
    [Fact]
    public void ParseProblemResponse_MissingStarterCode_FallsBackToFullResponseAsDescription()
    {
    ...
    [Fact]
    public void ParseProblemResponse_CaseInsensitiveMarkers()
    {
        var response = """
            description:
    ...
    [Fact]
    public void ParseProblemResponse_TrimsWhitespace()
    {
