...
public interface IAnthropicService
{
    ...
    Task<ChatResponse> GetGuidanceAsync(Guid sessionId, string userMessage, string? editorContent = null, bool isCodeAnalysis = false, CancellationToken ct = default);  // Sends a user message within an existing session and returns guided assistance with token usage
}
