  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-end gap-2 border-t border-gray-700 p-4">
      <textarea
        ...
        maxLength={2000}
        disabled={isLoading}
        className="flex-1 resize-none overflow-hidden rounded-lg bg-gray-850 px-4 py-2 text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-accent"
      />
      <button
        type="submit"
        disabled={isLoading}
